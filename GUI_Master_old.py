...
root.title("PLANT DISEASE DETECTION USING DEEP LEARNING")
...
#
lbl = tk.Label(root, text="PLANT DISEASE DETECTION USING DEEP LEARNING", font=('times', 35,' bold '), height=1, width=0,bg="maroon",fg="white")
lbl.place(x=0, y=3)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='C:Users\rohan\Desktop\22SS130-Plant Disease\Plant Disease Detection\test_set', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
