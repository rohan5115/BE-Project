...
path1 = 'C:Users\rohan\Desktop\22SS130-Plant Disease\Plant Disease Detection'    #path of folder of images    
path2 = 'C:Users\rohan\Desktop\22SS130-Plant Disease\Plant Disease Detection\test_set/2'  #path of folder to save images    
...
# # model.add(Conv2D(
# #         96, 11, strides=(4, 4), input_shape=(IMAGE_SIZE, IMAGE_SIZE, CHArNNELS), activation='relu'))
